...
export default class Cluster {
    ...
    load(options = {}) {
        ...
        this.myPrimitives = this._v.scene.primitives.add(new Cesium.PrimitiveCollection());
        // @ts-ignore
        ...
        primitiveCluster.minimumClusterSize = Cesium.defaultValue(options.minimumClusterSize, 2);
        ...
        function customStyle() {
            if (Cesium.defined(removeListener)) {
                ...
                removeListener = primitiveCluster.clusterEvent.addEventListener(function (clusteredEntities, cluster) {

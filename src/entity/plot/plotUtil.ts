...
export const P: PType = { version: "1.0.0" };
P.PlotUtils = {}, P.PlotUtils.distance = function(t: any, o: any) {
  return Math.sqrt(Math.pow(t[0] - o[0], 2) + Math.pow(t[1] - o[1], 2));
}, P.PlotUtils.wholeDistance = function(t: any) {
  for (var o = 0, e = 0; e < t.length - 1; e++) o += P.PlotUtils.distance(t[e], t[e + 1]);
  return o;
}, P.PlotUtils.getBaseLength = function(t: any) {
  return Math.pow(P.PlotUtils.wholeDistance(t), .99);
}, P.PlotUtils.mid = function(t: any, o: any) {
  return [(t[0] + o[0]) / 2, (t[1] + o[1]) / 2];
}, P.PlotUtils.getCircleCenterOfThreePoints = function(t: any, o: any, e: any) {
...
}, P.PlotUtils.getIntersectPoint = function(t: any, o: any, e: any, r: any) {
  if (t[1] == o[1]) {
...
}, P.PlotUtils.getAzimuth = function(t: any, o: any) {
...
}, P.PlotUtils.getAngleOfThreePoints = function(t: any, o: any, e: any) {
  var r = P.PlotUtils.getAzimuth(o, t) - P.PlotUtils.getAzimuth(o, e);
  return 0 > r ? r + P.Constants.TWO_PI : r;
}, P.PlotUtils.isClockWise = function(t: any, o: any, e: any) {
  return (e[1] - t[1]) * (o[0] - t[0]) > (o[1] - t[1]) * (e[0] - t[0]);
}, P.PlotUtils.getPointOnLine = function(t: any, o: any, e: any) {
  var r = o[0] + t * (e[0] - o[0]),
    n = o[1] + t * (e[1] - o[1]);
  return [r, n];
}, P.PlotUtils.getCubicValue = function(t: any, o: any, e: any, r: any, n: any) {
  ...
  return [u, c];
}, P.PlotUtils.getThirdPoint = function(t: any, o: any, e: any, r: any, n: any) {
  var g = P.PlotUtils.getAzimuth(t, o),
    i = n ? g + e : g - e,
    s = r * Math.cos(i),
    a = r * Math.sin(i);
  return [o[0] + s, o[1] + a];
}, P.PlotUtils.getArcPoints = function(t: any, o: any, e: any, r: any) {
  var n, g, i = [],
    s = r - e;
  ...
  return i;
}, P.PlotUtils.getBisectorNormals = function(t: any, o: any, e: any, r: any) {
  ...
  return [h, d];
}, P.PlotUtils.getNormal = function(t: any, o: any, e: any) {
  var r = t[0] - o[0],
    n = t[1] - o[1],
    g = Math.sqrt(r * r + n * n);
  r /= g, n /= g;
  ...
  var l = r + i,
    u = n + s;
  return [l, u];
}, P.PlotUtils.getCurvePoints = function(t: any, o: any) {
  ...
  for (n = 0; n < o.length - 1; n++) {
    ...
    for (var t: any = 0; t < P.Constants.FITTING_COUNT; t++) {
  ...
  return u;
}, P.PlotUtils.getLeftMostControlPoint = function(t: any, o: any) {
  var e = o[0],
    r = o[1],
    n = o[2],
  ...
  return [m, O];
}, P.PlotUtils.getRightMostControlPoint = function(t: any, o: any) {
  var e = o.length,
    r = o[e - 3],
    n = o[e - 2],
    g = o[e - 1],
  ...
  return [O, T];
}, P.PlotUtils.getBezierPoints = function(t: any) {
  ...
  return o.push(t[e]), o;
}, P.PlotUtils.getBinomialFactor = function(t: any, o: any) {
  return P.PlotUtils.getFactorial(t) / (P.PlotUtils.getFactorial(o) * P.PlotUtils.getFactorial(t - o));
}, P.PlotUtils.getFactorial = function(t: any) {
  if (1 >= t) return 1;
  if (2 == t) return 2;
  if (3 == t) return 6;
  if (4 == t) return 24;
  ...
  return o;
}, P.PlotUtils.getQBSplinePoints = function(t: any) {
  if (t.length <= 2) return t;
  var o = 2,
    e = [],
    r = t.length - o - 1;
...
}, P.PlotUtils.getQuadricBSplineFactor = function(t: any, o: any) {

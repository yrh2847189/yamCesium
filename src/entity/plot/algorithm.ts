...
let tailedAttackArrowDefualParam: any = {
    headHeightFactor: .18,
    headWidthFactor: .3,
    neckHeightFactor: .85,
    neckWidthFactor: .15,
...
xp.algorithm = {},
    xp.algorithm.doubleArrow = function (inputPoint: any) {
        this.connPoint = null;
    ...
    xp.algorithm.threeArrow = function (inputPoint: any) {
        this.connPoint = null;
        this.tempPoint4 = null;
    ...
    xp.algorithm.array2Dto1D = function (array: any) {
        let newArray: any = [];
        array.forEach(function (elt: any) {
            newArray.push(elt[0]);
            newArray.push(elt[1]);
        });
        return newArray;
    },
    xp.algorithm.getArrowPoints = function (t: any, o: any, e: any, r: any) {
    ...
    xp.algorithm.getArrowHeadPoints = function (t: any, o: any, e: any) {
        this.type = doubleArrowDefualParam.type,
            this.headHeightFactor = doubleArrowDefualParam.headHeightFactor,
            this.headWidthFactor = doubleArrowDefualParam.headWidthFactor,
            this.neckHeightFactor = doubleArrowDefualParam.neckHeightFactor,
    ...
    xp.algorithm.getArrowBodyPoints = function (t: any, o: any, e: any, r: any) {
        let u = [], c = [];
    ...
    xp.algorithm.getTempPoint4 = function (t: any, o: any, e: any) {
    ...
    xp.algorithm.tailedAttackArrow = function (inputPoint: any) {
    ...
    xp.algorithm.getAttackArrowHeadPoints = function (t: any, o: any, e: any, defaultParam: any) {
    ...
    xp.algorithm.getAttackArrowBodyPoints = function (t: any, o: any, e: any, r: any) {
        let u = [], c = [];
        for (let n = P.PlotUtils.wholeDistance(t), g = P.PlotUtils.getBaseLength(t), i = g * r, s = P.PlotUtils.distance(o, e), a = (i - s) / 2, l = 0, p = 1; p < t.length - 1; p++) {
            let h = P.PlotUtils.getAngleOfThreePoints(t[p - 1], t[p], t[p + 1]) / 2;
            l += P.PlotUtils.distance(t[p - 1], t[p]);
    ...
    xp.algorithm.dereplication = function (array: any) {
        let last = array[array.length - 1];
        let change = false;
        let newArray = [];
        newArray = array.filter(function (i: any) {
    ...
    xp.algorithm.fineArrow = function (tailPoint: any, headerPoint: any) {

...
class Plot {
        ...
        return new Promise((resolve, reject) => {
            const timeId = setInterval(() => {
                if (this._editParams.isEdit) {
                    ...
                    // @ts-ignore
                    this[`edit${this._editParams.shapeType}`](this._editParams.objId).then((res) => {
    ...
    drawPoint(options) {
        ...
        return new Promise((resolve, reject) => {
            this.plotTracker.trackPoint(options).then((position) => {
    ...
    editPoint(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.pointDrawer.showModifyPoint({ position: position }).then((position) => {
                this.draw.shapeDic[objId] = position;
    ...
    drawPolyline(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackPolyline(options).then((positions) => {
    ...
    createPolyline(positions, objId) {
    ...
    editPolyline(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.polylineDrawer.showModifyPolyline({ positions: positions }).then((positions) => {
                this.draw.shapeDic[objId] = positions;
    ...
    drawPolygon(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackPolygon(options).then((positions) => {
    ...
    editPolygon(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.polygonDrawer.showModifyPolygon({ positions: positions }).then((positions) => {
                console.log(positions);
                this.draw.shapeDic[objId] = positions;
    ...
    drawRectangle(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackRectangle(options).then((positions) => {
                console.log(positions);
                this.draw.shapeDic[objId] = positions;
    ...
    showRectangle(options) {
        const { positions, objId } = options;
        let entity = this.createRectangle(positions, objId);
        return { positions: positions, entity: entity };
    }
    createRectangle(positions, objId) {
    ...
    editRectangle(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.rectangleDrawer.showModifyRectangle({ positions: positions }).then((positions) => {
                console.log(positions);
                this.draw.shapeDic[objId] = positions;
    ...
    drawCircle(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackCircle(options).then((positions) => {
                console.log(positions);
                this.draw.shapeDic[objId] = positions;
    ...
    editCircle(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.circleDrawer.showModifyCircle({ positions: positions }).then((positions) => {
                console.log(positions);
                this.draw.shapeDic[objId] = positions;
    ...
    drawAttackArrow(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackAttackArrow(options).then((data) => {
    ...
    createAttackArrow(positions, objId) {
        const material = Cesium.Color.fromCssColorString("rgba(67,106,190,0.5)");
        const outlineMaterial = new Cesium.PolylineDashMaterialProperty({
            dashLength: 16,
            color: Cesium.Color.fromCssColorString("rgb(210,215,68)")
    ...
    editAttackArrow(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.attackArrowDrawer.showModifyAttackArrow({ custom: data.custom }).then((data) => {
                //保存编辑结果
                this.draw.shapeDic[objId] = {
                    custom: data.custom,
                    positions: data.positions
    ...
    drawPincerArrow(options) {
        this.draw.flag = 0;
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackPincerArrow(options).then((data) => {
                this.draw.shapeDic[objId] = {
                    custom: data.custom,
                    positions: data.positions
                };
    ...
    createPincerArrow(positions, objId) {
        const material = Cesium.Color.fromCssColorString("rgba(67,106,190,0.5)");
        const outlineMaterial = new Cesium.PolylineDashMaterialProperty({
            dashLength: 16,
            color: Cesium.Color.fromCssColorString("rgb(210,215,68)")
    ...
    editPincerArrow(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.pincerArrowDrawer.showModifyPincerArrow({ custom: data.custom }).then((data) => {
                //保存编辑结果
                this.draw.shapeDic[objId] = {
                    custom: data.custom,
                    positions: data.positions
    ...
    drawStraightArrow(options) {
        ...
        const objId = (new Date()).getTime() + "";
        return new Promise((resolve, reject) => {
            this.plotTracker.trackStraightArrow(options).then((positions) => {
                this.draw.shapeDic[objId] = {
                    positions: positions
                };
    ...
    showStraightArrow(options) {
        const { positions, objId } = options;
        let entity = this.createStraightArrow(positions, objId);
        return { positions: positions, entity: entity };
    }
    createStraightArrow(positions, objId) {
        const material = Cesium.Color.fromCssColorString("rgba(67,106,190,0.5)");
        const outlineMaterial = new Cesium.PolylineDashMaterialProperty({
            dashLength: 16,
            color: Cesium.Color.fromCssColorString("rgb(210,215,68)")
    ...
    editStraightArrow(objId) {
        ...
        this.clearEntityById(objId);
        return new Promise((resolve, reject) => {
            this.plotTracker.straightArrowDrawer.showModifyStraightArrow({ positions: positions }).then((positions) => {
                //保存编辑结果
                this.draw.shapeDic[objId] = {
                    positions: positions
                };

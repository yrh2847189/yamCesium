...
export const CesiumZh = (function () {
    ...
    function loadBaseLayerPickerOfToolbar() {
        ...
        //获取容器
        let dropDownContainer = document.querySelectorAll(".cesium-baseLayerPicker-dropDown");
        if (dropDownContainer.length > 0) {
            ...
            let selectLayerToolbar = document.querySelectorAll(".cesium-baseLayerPicker-selected");
            if (selectLayerToolbar.length > 0) {
                let toolbar = selectLayerToolbar[0];
                if (!toolbar || !toolbar.parentElement) {
                    return;
                }
                toolbar.parentElement.onmouseover = function (event) {
                    let target = event.currentTarget;
                    let currentTitle = target.getAttribute("title");
                    let currentTargets = currentTitle === null || currentTitle === void 0 ? void 0 : currentTitle.split("\n");
                    let tempTitle1 = "";
                    let tempTitle2 = "";
                    if (!currentTargets) {
                        return;
    ...
    function loadToolBarHelp() {
        ...
        //鼠标
        let mouseButtons = document.querySelectorAll(".cesium-navigation-button-left");
        let mouseButton, textContent;
        ...
        let touchButtons = document.querySelectorAll(".cesium-navigation-button-right");
        let touchButton;
    ...
    function loadFlyController() {
        let titles = getChineseMaps();
        let parentContainers = document.querySelectorAll(".cesium-viewer-animationContainer");
        let parentContainer;
        ...
        let timeLineBars = document.querySelectorAll(".cesium-timeline-bar");
        let timeLineBar;

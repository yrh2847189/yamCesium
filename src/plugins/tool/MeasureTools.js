"use strict";
// import cm from "../lib/CesiumMethod";
// import * as Cesium from "cesium";
//
// interface ViewModel {
//   measurePointEnabled: boolean,
...
//   }
//
//   closeOtherFunc(nowFunc: string) {
//     let _this = this;
//     for (const viewModelKey in this.viewModel) {
//       if (viewModelKey !== nowFunc) {
//         this.viewModel[viewModelKey as keyof ViewModel] = false;
//       }
//     }
...
//   measurePoint() {
//     let _this = this;
//     _this.viewer.screenSpaceEventHandler.setInputAction(function(event: typeof Cesium.Event) {
...
//     let _this = this;
//     let positions: any = [];
//     let clickStatus: any = false;
//     let labelEntity: any = null;
//     let totalLabelEntity: any = null;
//     let totalLengthText: any = "总距离：" + "0.00米";
//     let finalLengthText: any = "";
//     let firstCartesian: any = null;
//     // let dis = 0;
//     _this.viewer.screenSpaceEventHandler.setInputAction(function(clickEvent: any) {
...
//     let _this = this;
//     let positions: any = [];
//     let labelEntity_1: any = null; // 标签实体
//     let labelEntity_2: any = null; // 标签实体
//     let labelEntity_3: any = null; // 标签实体
//
//     // 注册鼠标左击事件
//     _this.viewer.screenSpaceEventHandler.setInputAction(function(clickEvent: any) {
//       let cartesian = _this.viewer.scene.pickPosition(clickEvent.position); // 坐标
...
//     }, Cesium.ScreenSpaceEventType.RIGHT_CLICK);
//
//     let createAreaLabel = function(coords: any) {
...
//   }
//
//   addLabel(centerPoint: any, text: any, isAddNode = true) {
//     let _this = this;
...
//   }
//
//   addLabelWithPoint(centerPoint: any, text: any) {
//     let _this = this;
//     return _this.viewer.entities.add(new Cesium.Entity({
//       position: centerPoint,
//       billboard: {
...
//   }
//
//   getLengthText(firstPoint: any, secondPoint: any) {
//     let _this = this;
//     // 计算距离
//     let length = 0;
//     if (firstPoint) {
...
//     } else {
//       res = Math.abs(Number((res / 1000000.0).toFixed(4))) + " 平方公里";
//     }
//
//     return res;
//
//   }
//
//   getCenterOfGravityPoint(mPoints: any) {
//     let _this = this;

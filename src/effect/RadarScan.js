...
class RadarScan {
    ...
    addRadarScan(options) {
        ...
        let _CartographicCenter1 = Cesium.Cartographic.fromCartesian(options.center);
        ...
        let _CartographicCenter2 = new Cesium.Cartographic(_CartographicCenter1.longitude + Cesium.Math.toRadians(0.001), _CartographicCenter1.latitude, _CartographicCenter1.height);
        ...
        let ScanPostStage = new Cesium.PostProcessStage({
            ...
            uniforms: {
                ...
                u_scanPlaneNormalEC() {
                    let temp = Cesium.Matrix4.multiplyByVector(viewer.camera.viewMatrix, _Cartesian4Center, _scratchCartesian4Center);
                    let temp1 = Cesium.Matrix4.multiplyByVector(viewer.camera.viewMatrix, _Cartesian4Center1, _scratchCartesian4Center1);
                ...
                u_scanLineNormalEC() {
                    let temp = Cesium.Matrix4.multiplyByVector(viewer.camera.viewMatrix, _Cartesian4Center, _scratchCartesian4Center);
                    let temp1 = Cesium.Matrix4.multiplyByVector(viewer.camera.viewMatrix, _Cartesian4Center1, _scratchCartesian4Center1);
                    let temp2 = Cesium.Matrix4.multiplyByVector(viewer.camera.viewMatrix, _Cartesian4Center2, _scratchCartesian4Center2);
                    _scratchCartesian3Normal.x = temp1.x - temp.x;
                    _scratchCartesian3Normal.y = temp1.y - temp.y;
                    _scratchCartesian3Normal.z = temp1.z - temp.z;
                    Cesium.Cartesian3.normalize(_scratchCartesian3Normal, _scratchCartesian3Normal);
                    ...
                    let tempTime = ((new Date().getTime() - _time) % options.duration) / options.duration;

...
class RadarScan {
   ...
   * @param options.duration 持续时间
   */
  addRadarScan(options: radarScanOptions) {
    let _this = this;
    ...
    let _CartographicCenter2 = new Cesium.Cartographic(
      _CartographicCenter1.longitude + Cesium.Math.toRadians(0.001),
      _CartographicCenter1.latitude,
      _CartographicCenter1.height
    );

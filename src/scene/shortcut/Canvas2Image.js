...
export const Canvas2Image = (function () {
    ...
    const $support = (function () {
        ...
        return {
            canvas: !!ctx,
            imageData: !!(ctx === null || ctx === void 0 ? void 0 : ctx.getImageData),
    ...
    function scaleCanvas(canvas, width, height) {
        ...
        retCtx === null || retCtx === void 0 ? void 0 : retCtx.drawImage(canvas, 0, 0, w, h, 0, 0, width, height);
        return retCanvas;
    }
    ...
    function saveFile(strData, fileType, fileName = "screenShot") {
    ...
    const genBitmapImage = function (oData) {
        ...
        return (encodeData(BITMAPFILEHEADER.concat(BITMAPINFOHEADER)) +

...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "./Immersion", "./hawkEyeMap/HawkEyeMap"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Cesium = __importStar(require("cesium"));
    var Immersion_1 = __importDefault(require("./Immersion"));
    var HawkEyeMap_1 = __importDefault(require("./hawkEyeMap/HawkEyeMap"));
    // @ts-ignore
    ...
    var Camera = /** @class */ (function () {
        function Camera(viewer) {
            ...
            this.viewer = viewer;
            this.immersion = new Immersion_1.default(viewer);
            this.hawkEye = new HawkEyeMap_1.default(viewer);
        }
        /**
         * 绕点旋转

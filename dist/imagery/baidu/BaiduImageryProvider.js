...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "./BaiduMercatorTilingScheme"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Cesium = __importStar(require("cesium"));
    var BaiduMercatorTilingScheme_1 = __importDefault(require("./BaiduMercatorTilingScheme"));
    ...
    var BaiduImageryProvider = /** @class */ (function () {
        ...
        function BaiduImageryProvider(options) {
            ...
            if (options.crs === "WGS84") {
                ...
                this._tilingScheme = new BaiduMercatorTilingScheme_1.default({

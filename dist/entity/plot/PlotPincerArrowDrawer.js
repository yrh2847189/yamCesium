...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "./PlotToolTip", "./algorithm", "../../plugins/lib/layer/Layer"], factory);
    }
            ...
            return new Promise(function (resolve, reject) {
                if (options && options.confirmHandler) {
                    ...
                    options.confirmHandler().then(function () {
                        ...
                        var doubleArrow = algorithm_1.xp.algorithm.doubleArrow(lonLats);
    ...
    exports.default = PlotPincerArrowDrawer;
});

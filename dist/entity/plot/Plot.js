...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "./PlotTracker", "./PlotMoveDrawer"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Cesium = __importStar(require("cesium"));
    var PlotTracker_1 = __importDefault(require("./PlotTracker"));
    var PlotMoveDrawer_1 = __importDefault(require("./PlotMoveDrawer"));
    var Plot = /** @class */ (function () {
        function Plot(viewer) {
            ...
            this.viewer = viewer;
            this.plotTracker = new PlotTracker_1.default(this.viewer);
            this.moveDrawer = new PlotMoveDrawer_1.default(this.viewer, this);
            this.bindGloveEvent();
        }

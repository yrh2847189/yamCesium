    ...
    var MeasureTools = /** @class */ (function () {
        ...
        MeasureTools.prototype.measureArea = function () {
                    ...
                    if (isDraw) {
                        ...
                        if (!Cesium.defined(polygon)) {
                            ...
                            if (polygonPath.length >= 4) {
                                var coordinates = CesiumMethod_1.default.cartesian3sToLngLats(polygonPath);
                                var first = CesiumMethod_1.default.cartesian3ToLngLat(polygonPath[0]);
            ...
            var createAreaLabel = function (coords) {
                var area = CesiumMethod_1.default.calcPolygonArea(coords).toFixed(2);
                ...
                var res = CesiumMethod_1.default.countPolygonCenter(polygon.path);
                var textArea = text;

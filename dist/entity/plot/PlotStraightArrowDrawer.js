...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./PlotToolTip", "cesium", "./algorithm", "../../plugins/lib/layer/Layer"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var PlotToolTip_1 = __importDefault(require("./PlotToolTip"));
    var Cesium = __importStar(require("cesium"));
    var algorithm_1 = require("./algorithm");
    var Layer_1 = __importDefault(require("../../plugins/lib/layer/Layer"));
    var PlotStraightArrowDrawer = /** @class */ (function () {
        function PlotStraightArrowDrawer(viewer) {
            ...
            _this.tooltip = new PlotToolTip_1.default(viewer.container);
        }
            ...
            return new Promise(function (resolve, reject) {
                if (options && options.confirmHandler) {
                    ...
                    options.confirmHandler().then(function () {
                        ...
                        var arrow = algorithm_1.xp.algorithm.fineArrow([firstPoint.lon, firstPoint.lat], [endPoints.lon, endPoints.lat]);
                        resolve(arrow);
                        _this_1.clear();
    ...
    exports.default = PlotStraightArrowDrawer;
});

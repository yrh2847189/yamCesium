(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "../../plugins/lib/CesiumMethod"], factory);
    }
    ...
    var PlotMoveDrawer = /** @class */ (function () {
                        ...
                        if (startPosition && endPosition) {
                            if (Cesium.defined(_this.currentsPoint)) {
                                ...
                                if (_this.pointDragged.id.shapeType == "Circle") {
                                    ...
                                    outlinePositions.push(_this.currentsPoint[0]); // 将第一个点添加到边框坐标中，让边框闭合
                                    _this.savePolylineCurrentsPoint = outlinePositions;
                                    _this.plot.draw.shapeDic[_this.objId] = CesiumMethod_1.default._computeCirclePolygon(_this.savePolylineCurrentsPoint);
                                }
                            }
                        }
        ...
        PlotMoveDrawer.prototype.clickCircle = function (pointDragged) {
            ...
            pointDragged.id.polyline.positions = new Cesium.CallbackProperty(function () {
                return CesiumMethod_1.default._computeCirclePolygon(_this.savePolylineCurrentsPoint);
            }, false);
        ...
        PlotMoveDrawer.prototype.confirmClick = function () {
            ...
            switch (this.obj.shapeType) {
                ...
                case "Circle":
                    ...
                    this.obj.polyline.positions = CesiumMethod_1.default._computeCirclePolygon(this.savePolylineCurrentsPoint);
                    break;
                case "BufferLine":
    ...
    exports.default = PlotMoveDrawer;
});

(function (factory) {
    ...
    var PlotPointDrawer_1 = require("./PlotPointDrawer");
    require("./css/plot.css");
    var PlotPolylineDrawer_1 = require("./PlotPolylineDrawer");
    var PlotPolygonDrawer_1 = require("./PlotPolygonDrawer");
    var PlotCircleDrawer_1 = require("./PlotCircleDrawer");
    var PlotRectangleDrawer_1 = require("./PlotRectangleDrawer");
    var PlotAttackArrowDrawer_1 = require("./PlotAttackArrowDrawer");
    var PlotPincerArrowDrawer_1 = require("./PlotPincerArrowDrawer");
    var PlotStraightArrowDrawer_1 = require("./PlotStraightArrowDrawer");

...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "cesium", "../core/loadView", "./ResetViewNavigationControl", "./ZoomNavigationControl", "../svgPaths/svgCompassOuterRing", "../svgPaths/svgCompassGyro", "../svgPaths/svgCompassRotationMarker", "../core/Utils"], factory);
    }
    ...
    var ResetViewNavigationControl_1 = __importDefault(require("./ResetViewNavigationControl"));
    var ZoomNavigationControl_1 = __importDefault(require("./ZoomNavigationControl"));
    var svgCompassOuterRing_1 = __importDefault(require("../svgPaths/svgCompassOuterRing"));
    var svgCompassGyro_1 = __importDefault(require("../svgPaths/svgCompassGyro"));
    var svgCompassRotationMarker_1 = __importDefault(require("../svgPaths/svgCompassRotationMarker"));
    ...
    var NavigationViewModel = /** @class */ (function () {
        function NavigationViewModel(options) {
            ...
            if (!defined(this.controls)) {
                this.controls = [
                    new ZoomNavigationControl_1.default(this.terria, true),
                    new ResetViewNavigationControl_1.default(this.terria),
                    new ZoomNavigationControl_1.default(this.terria, false)
                ];
            }
            // }
            this.svgCompassOuterRing = svgCompassOuterRing_1.default;
            this.svgCompassGyro = svgCompassGyro_1.default;
            this.svgCompassRotationMarker = svgCompassRotationMarker_1.default;
        ...
        NavigationViewModel.prototype.handleMouseDown = function (viewModel, e) {
            ...
            if (distanceFraction < norminalGyroRadius / nominalTotalRadius) {
                this.orbit(this, compassElement, vector);
                //            return false;
            }
            else if (distanceFraction < 1.0) {
                this.rotate(this, compassElement, vector);
                //            return false;
            }
            else {
                return true;
        ...
        NavigationViewModel.prototype.handleDoubleClick = function (viewModel, e) {
            ...
            var center = Utils_1.default.getCameraFocus(viewModel.terria, true, centerScratch);
            if (!defined(center)) {
        ...
        NavigationViewModel.prototype.orbit = function (viewModel, compassElement, cursorVector) {
            var scene = viewModel.terria.scene;
            var sscc = scene.screenSpaceCameraController;
        ...
        NavigationViewModel.prototype.rotate = function (viewModel, compassElement, cursorVector) {
            var scene = viewModel.terria.scene;
            var camera = scene.camera;
            var sscc = scene.screenSpaceCameraController;
            ...
            if (defined(viewModel.terria.trackedEntity)) {
                ...
                var viewCenter = Utils_1.default.getCameraFocus(viewModel.terria, true, centerScratch);
    ...
    // var NavigationViewModel = function (options: any) {
    //   this.terria = options.terria
    //   this.eventHelper = new EventHelper()
    //   this.enableZoomControls = (defined(options.enableZoomControls)) ? options.enableZoomControls : true
    //   this.enableCompass = (defined(options.enableCompass)) ? options.enableCompass : true
